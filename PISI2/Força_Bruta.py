...
for i in list(permutações):
    ...
    if i[0] == "R":
        ...
        if sum(distancia) < int(menor_rota[0]):
            ...
            rotas[sum(distancia)] = i # Adicionar a nova soma como chave e a nova rota como valor
...
menor_rota_visual = list(rotas[int(menor_rota[0])]) # Extrai a rota correspondente à menor soma de distâncias do dicionário rotas.
